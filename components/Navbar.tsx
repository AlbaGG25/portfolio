  ...
  return (
    <nav className="text-white fixed w-full bg-black bg-opacity-90 md:bg-opacity-60 z-50 p-4 md:p-8">
      <div className="flex cursor-pointer md:h-full">
        ...
        <div
          className={`fixed md:relative inset-0 flex flex-col md:flex-row justify-center md:justify-end items-center bg-black sm:bg-opacity-90 md:bg-transparent transition-transform duration-300  ${
